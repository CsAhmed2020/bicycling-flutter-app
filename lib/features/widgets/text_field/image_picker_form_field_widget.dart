...
import 'package:bicycling_app/features/widgets/modal_sheet/app_bottom_sheet.dart';
import 'package:bicycling_app/features/widgets/picker_option_widget.dart';
import 'package:bicycling_app/res/app_asset_paths.dart';
import 'package:bicycling_app/utils/cached_network_image/app_cached_network_image.dart';
...
import 'package:bicycling_app/utils/validations/validator.dart';
  ...
  Future<void> _pickFile() async {
    ...
    if (result != null) {
      ...
      if (!allowedExtensions.contains(platformFile.extension?.toLowerCase())) {
        //showFeedbackMessage(translate(LocalizationKeys.attachmentsMustBeFilledPdfFileFormat)!);
      } else if (platformFile.size / 1000 > 10000) {
        //showFeedbackMessage(translate(LocalizationKeys.theSizeOfTheFileShouldBeLessThan10Mg)!);
      } else {
